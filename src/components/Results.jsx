  ...
  const getHearingInterpretation = () => {
    ...
    if (avgDb <= 25) {
      ...
      return {
        ...
        hearingAid: '/images/hearing-aids/image1.webp',
        hearingAidTitle: 'Подходящий аппарат: Signia Pure Charge&Go AX',
        hearingAidDescription: 'Современный компактный заушный слуховой аппарат с технологией Augmented Xperience. Подходит при лёгкой потере слуха, помогает лучше различать речь в шуме, автоматически подстраивается под обстановку. Имеет стильный дизайн, зарядный футляр и Bluetooth-подключение.'
      };
    } else if (avgDb <= 55) {
      return {
        // 3 СТЕПЕНЬ
        ...
        hearingAid: '/images/hearing-aids/image2.webp',
        hearingAidTitle: 'Подходящий аппарат: Signia Motion Charge&Go X',
        hearingAidDescription: 'Универсальный перезаряжаемый заушный аппарат, рассчитанный на лёгкую и умеренную потерю слуха. Оснащён интеллектуальными сенсорами движения, адаптируется к различным акустическим ситуациям. Обеспечивает естественное звучание и комфорт в повседневном общении.'
      };
    } else if (avgDb <= 70) {
      return {
        // 4 СТЕПЕНЬ
        ...
        hearingAid: '/images/hearing-aids/image3.webp',
        hearingAidTitle: 'Подходящий аппарат: Signia Motion Charge&Go P X',
        hearingAidDescription: 'Модель повышенной мощности (Power), созданная для пользователей со средне-тяжёлой потерей слуха. Имеет направленные микрофоны, шумоподавление и поддержку Bluetooth. Обеспечивает чёткую речь даже в сложных акустических условиях.'
      };
    } else {
      return {
        // 5 СТЕПЕНЬ
        ...
        hearingAid: '/images/hearing-aids/image4.webp',
        hearingAidTitle: 'Подходящий аппарат: Signia Motion Charge&Go SP X',
        hearingAidDescription: 'Слуховой аппарат класса Super Power. Предназначен для людей с выраженной потерей слуха. Обеспечивает максимальное усиление звука без искажений, высокую разборчивость речи и устойчивую работу даже в шумных помещениях. Оснащён функцией беспроводной зарядки и возможностью подключения к смартфону.'
      };
    } 
  };
